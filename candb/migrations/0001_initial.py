# Generated by Django 5.1.1 on 2024-11-23 07:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, help_text='Phone Number', max_length=22, null=True)),
                ('image', models.ImageField(blank=True, default='default.jpg', null=True, upload_to='profile_pics')),
                ('balance', models.DecimalField(decimal_places=2, default=0, help_text='User Balance', max_digits=10)),
                ('adminNotes', models.TextField(default=None, help_text='Admin Notes', max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('totalCost', models.DecimalField(decimal_places=2, help_text='Order Total Practical Price', max_digits=10, null=True)),
                ('totalPaid', models.DecimalField(decimal_places=2, default=0, help_text='Total Paid', max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability', models.JSONField(decoder=candb.common.DateTimeDecoder, default=None, encoder=candb.common.DateTimeEncoder, help_text='Product Availability Configuration', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costPaid', models.DecimalField(decimal_places=2, default=0, help_text='Cost Paid', max_digits=10)),
                ('status', models.CharField(choices=[('Pending', 'P'), ('Open', 'O'), ('Waiting_for_Balance', 'W'), ('Confirmed', 'C'), ('In_Production', 'I'), ('Delivered', 'D'), ('Returned', 'R'), ('Cancelled', 'X'), ('Locked', 'L'), ('Standing_by_for_Stock', 'S'), ('Standing_by_for_Stock_But_Locked', 'B')], default='P', help_text='Order Status', max_length=32, null=True)),
                ('notes', models.TextField(default=None, help_text='Order Line Notes', max_length=500, null=True)),
                ('availabilityIDs', models.JSONField(default=None, help_text='ID of Stock Configuration used in linked Product for availability', null=True)),
                ('_saveVersion', concurrency.fields.IntegerVersionField(default=0, help_text='Save Version for Concurrency Control')),
        ...
        migrations.AddConstraint(
            model_name='orderline',
            constraint=models.CheckConstraint(condition=models.Q(('costPaid__gte', 0)), name='CanDB_OrderLine_CostPaid_NonNegative', violation_error_code='ORDERLINE-COSTPAID-1', violation_error_message='Cost paid must not be negative'),
        ),
    ]
